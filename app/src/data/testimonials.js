...
// Schema: { id, name, initials, role ("<treatment> · <clinic>"), quote, rating (1–5), placeholder, doctorId? }
// `doctorId` links a story to a doctor's profile page (the profile mock shows the first three under Dr. Smita).
export const TESTIMONIALS = [
  { id: 't1', doctorId: 'smita-gutgutia', name: 'Isha Agarwal', initials: 'IA', role: 'Pregnancy Care · Kankurgachi', rating: 5, placeholder: true,
  ...
  { id: 't2', doctorId: 'smita-gutgutia', name: 'Harshita Nahata', initials: 'HA', role: 'Antenatal Care · Kankurgachi', rating: 5, placeholder: true,
  ...
  { id: 't3', doctorId: 'smita-gutgutia', name: 'Sushmita Mitra', initials: 'SM', role: 'Medical Care · CMC', rating: 5, placeholder: true,
