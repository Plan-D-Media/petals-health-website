...
export default {
  ...
  hero: {
    ...
    photo: { src: '/assets/treatments/yoga-hero.jpg', alt: 'A woman seated in a meditation pose', position: '78% 100%', blend: true }   /* the source is a wide 1919 × 820 rectangular frame (not a cut-out) with its own pale-blue backdrop, subject right of centre: `blend` dissolves it into the hero gradient (design/treatment-redesign.md, item 1); a true cut-out from the client replaces it */,
  },
  intro: null,
