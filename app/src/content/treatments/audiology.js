...
export default {
  ...
  hero: {
    ...
    photo: { src: '/assets/treatments/audiology-hero.png', mask: '/assets/treatments/audiology-hero-mask.png', alt: 'An audiologist examining a patient’s ear with an otoscope', position: '20% 30%' },
  },
