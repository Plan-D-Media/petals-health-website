...
import { Hero, ServiceGrid, Team, Related, SideForm, focusForm } from './TreatmentA.jsx'
...
//   open hero (+ facts, + track pills on multi-track pages) · a two-column split (2026-09-22): the content column —
//   intro · [IVF: explained · icon grid · featured · why-choose · journey · conversation] · groups (tracks: each a
//   band with the ranked grid; a sticky track index on desktop) · risks & safety · the answered FAQs or the package —
//   beside the sticky consultation form · then full width: team · related · footer.
      ...
      <main id="main" tabIndex={-1}>
        ...
        <div className="inner"><div className="tsplit">
          <div className="tsplit__main" onClick={focusForm}>
                ...
                <div className="inner">
                  ...
                  <ol className="ts__grid tk__grid">
                    ...
                    <li className="tc tc--ask tk__cta" aria-label={c.iconGrid.cta.label}>
                      ...
                      <a className="tc__ask" href="#consult">{c.iconGrid.cta.label} <Arrow /></a>
                    </li>
                  </ol>
                </div>
              </section>
              ...
              <section className="tn tb" aria-labelledby="t-convo-title">
                <div className="inner tn__inner">
                  ...
                  <div className="tn__actions">
                    <a className="tn__primary" href="#consult">{c.conversation.primary.label}</a>
            ...
            {(c.faq || c.package) && (
              <section className="tv tb tv--column" aria-labelledby="t-visit-title">
                <div className="inner">
                  {c.faq && <Faq faq={c.faq} />}
                  {!c.faq && c.package && (
