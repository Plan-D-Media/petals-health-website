...
const STATIC = [
  ...
  { path: '/find-a-doctor/', title: t('Find a Doctor'), description: 'Search our specialists by name, specialty, or clinic. 100+ doctors across three clinics in Kolkata — filter by availability, video consult, language and rating.', priority: 0.9, changefreq: 'weekly', lcp: ['/assets/doctors/find-hero.webp'], chunks: ['src/pages/FindDoctor.jsx'] },
]
