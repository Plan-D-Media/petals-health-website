...
const STATIC = [
  ...
  { path: '/petals-clinic-in-bangladesh/', title: t('Petals Clinic in Bangladesh'), description: 'Petals Healthcare, Soon in Bangladesh. A New Chapter in Compassionate Care Begins.', priority: 0.5, changefreq: 'monthly', lcp: ['/assets/bangladesh/hero.webp'], chunks: ['src/pages/Bangladesh.jsx'], forms: false },   // copy from the client's page (src/content/bangladesh.js); no lead form (src/contact.js), the gate checks there is no trigger
]
